...
El Asistente para aplicaciones ha creado esta aplicación MiRana.
...
constituyen su aplicación MiRana.
...
MiRanaDlg.h, MiRanaDlg.cpp – el cuadro de diálogo
    Estos archivos contienen su clase CMiRanaDlg.  Esta clase define 
    el comportamiento del cuadro de diálogo principal de su aplicación. La 
    plantilla del cuadro de diálogo está en MiRana.rc, que puede 
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado MiRana.pch y un archivo de 
